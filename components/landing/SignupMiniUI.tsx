...
export function SignUpMiniUI() {
  return (
    <div className="backdrop-blur-md relative shadow-inner border border-appGold20 hover:border-appGold100 transition-all duration-300 ease-in-out hover:shadow-appGold100 shadow-appGold20 p-6 rounded-lg max-w-sm mx-auto">
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-1">
          <div className="w-full px-3 appearance-none py-2 text-appGold20 border rounded-md">
            Email
          </div>
          <div className="w-full px-3 appearance-none py-2 text-appGold20 border rounded-md">
            Password
