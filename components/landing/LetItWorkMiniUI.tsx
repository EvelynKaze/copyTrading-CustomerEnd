  ...
  return (
    <div className="backdrop-blur-md relative shadow-inner border border-appGold20 shadow-appGold20 transition-all duration-300 ease-in-out hover:border-appGold100 hover:shadow-appGold100 p-6 rounded-lg max-w-sm mx-auto">
      ...
      <div className="bg-appDarkCard p-4 rounded-md">
        ...
        <div className="w-full text-appGold20 overflow-hidden rounded-full h-2.5">
          <motion.div
        ...
        <div className="flex justify-between items-center mt-2">
          <span className="text-xs text-appGold20">Last Month</span>
          <span className="text-xs text-appGold20">This Month</span>
        </div>
      </div>
    </div>
  );
